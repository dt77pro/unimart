                            ...
                            @if ($pages->total() > 0)
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td style="width: 20%; font-weight: bold; font-size: 14.5px">{{$page->title}}</td>
                                        <td style="width: 20%">{{$page->slug}}</td>
                                        ...
                                        <td>
                                            <a href="{{route('restore_trash', $page->id)}}" onclick="return confirm('Bạn có chắc chắn muốn khôi phục trang {{$page->title}} không?')"><button style="font-size: 1rem" class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Khôi phục"><i class="far fa-trash-undo"></i></button></a>
                                            <a href="{{route('forceDelete_trash', $page->id)}}" onclick="return confirm('Bạn có chắc chắn muốn xóa vĩnh viễn {{$page->title}} không?')"><button style="font-size: 1rem" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Xóa vĩnh viễn"><i class="far fa-trash-alt fa-1x"></i></button></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
