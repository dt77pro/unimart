...
{{-- @extends('layouts.front_end.header') --}}
...
{{-- <div id="main-content-wp" class="home-page clearfix">
    <div class="wp-inner">
        <div class="main-content fl-right"> 
            ...
            @include('users.support')
            @include('users.feature_product')
            <div class="section" id="list-product-wp">
                <div class="section-head">                      
                    <h3 class="section-title">{{$products->cate_id}}</h3>
                </div>
                    ...
                    <ul class="list-item clearfix">
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-17.png')}}">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-18.png')}}">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-19.png')}}">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-20.png')}}">
                            </a>
                            <a href="" title="" class="product-name">Laptop Lenovo IdeaPad 110</a>
                            <div class="price">
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-21.png')}}">
                            </a>
                            <a href="" title="" class="product-name">Laptop Asus X441NA</a>
                            <div class="price">
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-22.png')}}">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-05.png')}}">
                            </a>
                        ...
                        <li>
                            <a href="" title="" class="thumb">
                                <img src="{{asset('/css/user/images/img-pro-23.png')}}">
                            </a>
        ...
        <div class="sidebar fl-left">
            @include('users.product.list_cate_product')
            {{-- //List_cate --}}
{{--             
                    ...
                    <ul class="list-item">
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-13.png')}}" alt="">
                            </a>
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-11.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-12.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-05.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-22.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-23.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-18.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{asset('/css/user/images/img-pro-15.png')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
...
{{-- </div>    --}}
{{-- @endsection --}}
{{-- @extends('layouts.front_end.footer') --}}
