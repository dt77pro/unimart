    ...
    <div class="col-md-3" style="margin: 0px auto; text-align: center">
        <div class="form-login">
            <form action="" method="POST">
                ...
                <div class="form-group my-4">
                  <input  style="padding: 15px 10px;" type="password" class="form-control" placeholder="Mật khẩu" name="password">
                </div>
                @error('password')
                    <small class="alert alert-danger message">{{$message}}</small>
                @enderror
                ...
                <div class="form-group mt-4">
                    <button type="submit" value="Đăng nhập" class="btn login" >Đăng nhập</button>
                    <div class="mt-1">
                        <a href="" style="color: #1877f2; ">Quên mật khẩu?</a>
                    </div>
                </div>
                <hr>

                <div>
                    <button type="submit" value="Đăng nhập" class="btn register my-4">Tạo tài khoản mới</button>
                </div>
